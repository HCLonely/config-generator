...
You have to input at least one of them.`),!1}return console.log(r(t)),r(t)}catch(e){return console.error(e),o(e.message),!1}}(e);e&&($("#file-selector,#loadRemoteFileLabel,#loadRemoteFileInput").hide(),e.forEach((a,e)=>{$("div.container").append(`<form id="config-${d(a.name).replace(/[^\w\d-_]/gi,"")}" style="display:none;" data-type="${a.type||a.filename.split(".").slice(0,-1).join(".")}" data-filename="${a.filename||a.name+"."+a.type}">
